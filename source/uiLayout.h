...
namespace UILayout
{
	...
	constexpr int32_t PLAYER_IMAGE_INTERNAL_BORDER_PADDING_X	= 10;
	constexpr int32_t PLAYER_IMAGE_INTERNAL_BORDER_PADDING_Y	= 10;

	constexpr int32_t PLAYER_0_POS_X							= PLAYER_IMAGE_EXTERNAL_BORDER_PADDING_X;
	constexpr int32_t PLAYER_0_POS_Y							= PLAYER_IMAGE_EXTERNAL_BORDER_PADDING_Y;
	constexpr int32_t PLAYER_1_POS_X							= PLAYER_0_POS_X + PLAYER_IMAGE_WIDTH + PLAYER_IMAGE_INTERNAL_BORDER_PADDING_X;
	...
	constexpr int32_t PLAYER_FRAME_WIDTH						= PLAYER_IMAGE_WIDTH + (PLAYER_FRAME_BORDER_SIZE * 2);
	constexpr int32_t PLAYER_FRAME_HEIGHT						= PLAYER_IMAGE_HEIGHT + (PLAYER_FRAME_BORDER_SIZE * 2);
	...
	constexpr int32_t WEAPON_HEIGHT								= PLAYER_IMAGE_HEIGHT;
	...
	const int32_t ImagePosAndDimensions[PlayerImageSlot::Count][4]
	{
		...
		{ FULLSCREEN_OFFSET_X, FULLSCREEN_OFFSET_Y, PLAYER_IMAGE_WIDTH, PLAYER_IMAGE_HEIGHT }			// Fullscreen
	};
