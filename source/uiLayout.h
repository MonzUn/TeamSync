...
namespace UILayout
{
	...
	constexpr int32_t MAIN_MENU_BORDER_PADDING		= 10;
	...
	constexpr int32_t QUIT_BUTTON_WIDTH		= 100;
	constexpr int32_t QUIT_BUTTON_HEIGHT	= 50;
	...
	constexpr int32_t QUIT_BUTTON_POS_X		= APPLICATION_WINDOW_WIDTH - QUIT_BUTTON_WIDTH - MAIN_MENU_BORDER_PADDING;
	constexpr int32_t QUIT_BUTTON_POS_Y		= APPLICATION_WINDOW_HEIGHT - QUIT_BUTTON_HEIGHT - MAIN_MENU_BORDER_PADDING;
