...
namespace UILayout
{
	...
	constexpr int32_t MAIN_MENU_SMALL_BUTTON_WIDTH	= 120;
	...
	constexpr int32_t APP_TITLE_TEXT_BOX_HEIGHT = 150;
	...
	// Positions
	constexpr int32_t HOST_BUTTON_POS_X		= APPLICATION_WINDOW_WIDTH / 2 - MAIN_MENU_BIG_BUTTON_WIDTH / 2;
	...
	constexpr int32_t IP_TEXT_BOX_POS_Y		= CONNECT_BUTTON_POS_Y + (MAIN_MENU_BIG_BUTTON_HEIGHT / 2) - (IP_TEXT_BOX_HEIGHT / 2);
	...
	// ---------- About ----------
	// Sizes
	constexpr int32_t ABOUT_BACK_BUTTON_WIDTH	= 100; // TODODB: Prefix all sizes and positions with the scrreen in which they are used
