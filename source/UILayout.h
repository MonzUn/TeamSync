...
namespace UILayout
{
	...
	constexpr int32_t MAIN_MENU_RANDOMIZE_NAME_BUTTON_WIDTH = MAIN_MENU_PLAYER_NAME_TEXT_BOX_WIDTH;
	constexpr int32_t MAIN_MENU_RANDOMIZE_NAME_BUTTON_HEIGHT = 40;
	...
	// Padding
	constexpr int32_t PLAYER_NAME_INPUT_TEXT_BOX_TO_RANDOMIZE_PLAYER_NAME_BUTTON_PADDING_Y = 5;
	...
	constexpr int32_t UPDATE_BUTTON_POS_X			= REPORT_BUG_BUTTON_POS_X + MAIN_MENU_SMALL_BUTTON_WIDTH + MAIN_MENU_HORIZONTAL_BUTTON_SPACING;
	constexpr int32_t UPDATE_BUTTON_POS_Y			= ABOUT_BUTTON_POS_Y;
	...
	constexpr int32_t RANDOMIZE_NAME_BUTTON_POS_X = PLAYER_NAME_TEXT_BOX_POS_X;
	constexpr int32_t RANDOMIZE_NAME_BUTTON_POS_Y = PLAYER_NAME_TEXT_BOX_POS_Y + MAIN_MENU_INPUT_TEXT_BOX_HEIGHT + PLAYER_NAME_INPUT_TEXT_BOX_TO_RANDOMIZE_PLAYER_NAME_BUTTON_PADDING_Y;
	...
	constexpr int32_t PLAYER_PRIME_INDICATOR_DEPTH				= 4;
