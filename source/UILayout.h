...
namespace UILayout
{
	...
	constexpr int32_t PLAYER_FRAME_DEPTH						= 1;
	...
	constexpr int32_t PLAYER_PRIME_INDICATOR_DEPTH				= 0;
	...
	constexpr int32_t PLAYER_DEFAULT_IMAGE_DEPTH				= 1;
	...
	constexpr int32_t IMAGE_DEPTH								= 1;
