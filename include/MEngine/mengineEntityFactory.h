...
namespace MEngine
{
	EntityID CreateButton(int32_t posX, int32_t posY, int32_t width, int32_t height, std::function<void()> callback,
		uint32_t posZ = MENGINE_DEFAULT_UI_BUTTON_DEPTH, TextureID texture = INVALID_MENGINE_TEXTURE_ID, const std::string& Text = "");

	EntityID CreateTextBox(int32_t posX, int32_t posY, int32_t width, int32_t height, uint32_t posZ = MENGINE_DEFAULT_UI_TEXTBOX_DEPTH, bool editable = false,
